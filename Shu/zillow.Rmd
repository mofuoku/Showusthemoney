...
numeric_ <- numeric_[-c(4,5,11)] #rm "propertycountylandusecode","propertyzoningdesc","censustractandblock" 

numeric_ <- append(numeric_,"calculatedfinishedsquarefeet")
categorical <- categorical[-3] # rm "calculatedfinishedsquarefeet"
categorical <- categorical[-12] # rm assessmentyear

categorical <- append(categorical,"censustractandblock")
numeric_ <- numeric_[-2] # rm "bedroomcnt"
numeric_ <- numeric_[-3] # rm "fireplaceflag"
